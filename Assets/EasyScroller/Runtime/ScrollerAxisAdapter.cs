...
public static class ScrollerAxisAdapter
{
    ...
    public static float GetLayoutPreferredSize(RectTransform rect, ScrollerAxis axis)
    {
        if (rect == null)
        {
            return 0f;
        ...
        return axis == ScrollerAxis.Vertical
            ? UnityEngine.UI.LayoutUtility.GetPreferredHeight(rect)
            : UnityEngine.UI.LayoutUtility.GetPreferredWidth(rect);
    }
